...
const ProgressBar = ({ data, total, Date, IconLogo, MiniLogo, hasRedBorder }) => {
    ...
    const containerStyle = {
        ...
        shadowOpacity: 1,
        shadowRadius: 10,
        borderWidth: hasRedBorder ? 1 : 1,
        borderColor: hasRedBorder ? 'red' : 'gray',
        ...
        <View style={{ flexDirection: 'row', paddingLeft: 15, paddingBottom: 12, paddingRight: 10, width: "100%", height: windowHeight*0.1, borderRadius: 50, shadowColor: '#000', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.1, shadowRadius: 20, marginTop: 16 }}>
            <View style={{ flex: 1 }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', height: 50, alignItems: 'center' }}>
                    ...
                    {MiniLogo && 
                    <Image source={MiniLogo} style={{ width: 25, height: 25, marginLeft:"28%" }} />}
                    <Text style={{ marginRight: 10, fontSize: 18, fontWeight: 'bold', textAlign: 'right',color:"black" }}>{Date}</Text>
                </View>
    
                <View style={[containerStyle, { height: 10, flexDirection: 'row-reverse', alignItems: 'center', width: '100%' }]}>
                    <View style={{ flex: 1, height: '100%', backgroundColor: 'rgb(239 246 255)', borderRadius: 100 }}>
                        <View style={[containerStyle, { height: '100%', flexDirection: 'row-reverse', alignItems: 'center', width:`${percentage}%` }]}>
            ...
            {IconLogo &&
                <View style={{ width: 60, height: 60, borderRadius: 30, marginRight: 10, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', shadowColor: '#000', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.1, shadowRadius: 10 }}>
